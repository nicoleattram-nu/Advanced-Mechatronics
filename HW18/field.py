...
Shows the force profile and current angle marker.

Run alongside paddle_field.py
This is a static display — rotate paddle in field.py to see the marker move.
"""
